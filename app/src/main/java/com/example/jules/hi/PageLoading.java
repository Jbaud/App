...
public class PageLoading extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        broadcastReceiverOk = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intentOk) {
                ...
                //HomePage activity
                Intent intent = new Intent(getApplicationContext(), PageHome.class);
    ...
    protected void onPause() {
        super.onPause();
        unregisterReceiver(broadcastReceiverKo);
        unregisterReceiver(broadcastReceiverOk);
    }
}
